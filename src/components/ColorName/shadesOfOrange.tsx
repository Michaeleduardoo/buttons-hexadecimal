...
const Page = () => {
  const colors = [
    { text: "OrangeRed", colorClass: "orangeRed" },
    { text: "DarkOrange", colorClass: "darkOrange" },
    { text: "Seigneurie", colorClass: "seigneurie" },
    { text: "Fire", colorClass: "fire" },
    { text: "Sandstone", colorClass: "sandstone" },
  ];
